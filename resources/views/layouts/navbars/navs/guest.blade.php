                ...
                <li class="nav-item dropdown">
                    <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button"
                       data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                        @switch($locale)
                            @case('en')
                                {{ __('application.English') }}
                            @break
                            @case('hi')
                                {{ __('application.Hindi') }}
                            @break
                            @default
                                {{ __('application.English') }}
                        @endswitch
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="/lang/en"><img src="{{asset('img/flags/US.png')}}" width="25px"> {{ __('application.English') }}</a>
                        <a class="dropdown-item" href="/lang/hi"><img src="{{asset('img/flags/IN.png')}}" width="25px"> {{ __('application.Hindi') }}</a>
                    </div>
                </li>                 
            </ul>
        </div>
